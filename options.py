...
def get_options():
    ...
    tf.app.flags.DEFINE_string("run_ID", "seq_10_batch_200_RNN_529_dense_rf_2_l2_0", "save_ID")
    ...
    tf.app.flags.DEFINE_integer("num_g_cells", 529, "num grid cells")
    tf.app.flags.DEFINE_integer("rnn_size", 529, "num units in RNN")
