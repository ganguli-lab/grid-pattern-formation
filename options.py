...
def get_options():
    ...
    tf.app.flags.DEFINE_string("run_ID", "seq_10_batch_200_RNN_1024_rf_2_DOG_periodic_lr_4", "save_ID")
    ...
    tf.app.flags.DEFINE_float("nonneg_obj", 1e-3, "strength nonneg constraint")
    ...
    tf.app.flags.DEFINE_string("dataset", 'ben_10_step_periodic', "filepath")
