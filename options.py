...
def get_options():
    ...
    tf.app.flags.DEFINE_string("run_ID", "seq_100", "save_ID")
    tf.app.flags.DEFINE_integer("batch_size", 10, "batch size") # 10
    ...
    tf.app.flags.DEFINE_string("dataset", 'ben_100_step', "location of dataset")
